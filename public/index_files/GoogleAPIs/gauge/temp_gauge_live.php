<html>
  <head>
   ...
   <script type="text/javascript">
      ...
      google.charts.setOnLoadCallback(draw_Temp_Chart);
      ...
      function draw_Temp_Chart() {
        ...
        setInterval(function() {
          $.get("index_files/GoogleAPIs/gauge/alive.php?payload=joto", function(return_value) {
  ...
  <body>
    <div id="Temp_chart_div" style="width: 400px; height: 120px;"></div>
  </body>
</html>
